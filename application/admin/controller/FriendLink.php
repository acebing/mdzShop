...
class FriendLink extends Base
{
  ...
  {
    $list = $this->obj->list();
    return $this->view->fetch('mallsite/friend_link_list',[
    'list'=>$list
    ]);
  }
  ...
  {
    return $this->view->fetch('mallsite/friend_link_add');
  }
  ...
  public function edirFriendLink()
  {
    ...
    return $this->view->fetch('mallsite/friend_link_edit',[
      'editList'=>$editList
      ]);
  }
